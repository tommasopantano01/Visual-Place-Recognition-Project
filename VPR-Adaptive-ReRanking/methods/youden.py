...
_VALIDATION_DIR = Path(__file__).resolve().parent.parent / "validation" / "youden"


def parse_args():
    parser = argparse.ArgumentParser(description="Adaptive reranking — youden")
...
def main(args):
    ...
    print(f"threshold (youden) = {threshold}  [{args.model}/{args.matcher}]")
