"""
logistic_help/logistic_help_calibrate.py — Allena P(help | num_inliers) e
calibra tau su validation. Scrive threshold.csv + model.json.

Uso:
    python VPR-adaptive-re-ranking/logistic_help/logistic_help_calibrate.py \
...
def parse_args():
    parser = argparse.ArgumentParser(description="Calibra logistic P(help) — metodo6")
